...
-- -----------------------------------------------------
-- Table `test_pds`.`Consumers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `test_pds`.`Consumers` ;

CREATE TABLE IF NOT EXISTS `test_pds`.`Consumers` (
  `id_Consumers` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_Consumers`, `id_Agency`, `id_user`, `id_account`, `Account_id_account`),
  INDEX `fk_Consumers_Agency1_idx` (`id_Agency` ASC),
  INDEX `fk_Consumers_user1_idx` (`id_user` ASC),
  INDEX `fk_Consumers_Account1_idx` (`Account_id_account` ASC),
