...
public class ConnectionPool{
	...
	private static Log4JLogger LOG = new Log4JLogger(ConnectionPool.class.getName());
	...
	public ConnectionPool(String driverName, String database, String dbuser, String dbpassword) {
	...
	private void initializeConnectionPool()
	{
		...
		{
			LOG.logInfo("Connection Pool is NOT full! Proceeding with adding new connections");
